...
import { CalendarDays, Cog, Plus, Scan } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        {/* Header Section */}
        <div className="bg-gradient-to-r from-yellow-300 to-yellow-400 px-6 py-8 text-white">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex flex-wrap justify-center gap-4">
                  <Link
                    ...
                    className="flex items-center gap-2 bg-yellow-300 text-white px-4 py-2 rounded-lg hover:bg-yellow-500 transition-colors"
                  >
          ...
          {!stripeConnectId && !accountCreatePending && (
            <div className="text-center py-8">
              ...
              <button
                ...
                className="bg-yellow-300 text-white px-6 py-2 rounded-lg hover:bg-yellow-500 transition-colors"
              >
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  ...
                  {!accountLinkCreatePending && (
                    <button
                      ...
                      className="mt-4 bg-yellow-300 text-white px-4 py-2 rounded-lg hover:bg-yellow-500 transition-colors"
                    >
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                {accountStatus.isActive && (
                  <button
                    ...
                    className="bg-yellow-300 text-white px-4 py-2 rounded-lg hover:bg-yellow-500 transition-colors flex items-center"
                  >
