  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-slate-900">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="bg-white/80 px-4 py-2 rounded-lg shadow-sm border border-slate-200/70">
      ...
      {upcomingEvents.length > 0 ? (
        ...
        <div className="bg-white/70 rounded-lg p-12 text-center mb-12 border border-slate-200/70">
