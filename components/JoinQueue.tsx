        ...
        <>
          {isEventOwner ? (
            ...
            <button
              ...
              className="w-full bg-yellow-300 text-white px-6 py-3 rounded-lg font-medium hover:bg-yellow-500 transition-colors duration-200 shadow-md flex items-center justify-center disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Buy Ticket
            </button>
          )}
