    ...
    return (
      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
        <div className="flex items-center">
          ...
          <span className="text-yellow-500">Queue position</span>
        </div>
        <span className="bg-blue-100 text-yellow-500 px-3 py-1 rounded-full font-medium">
          #{queuePosition.position}
        </span>
      </div>
    );
      ...
      {imageUrl && (
        <div className="aspect-[21/9] relative w-full overflow-hidden">
          ...
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent z-30 pointer-events-none" />
        </div>
      )}
        ...
        <div className="flex justify-between items-start">
          <div>
            <div className="flex flex-col items-start gap-2">
              {isEventOwner && (
                <span className="inline-flex items-center gap-1 bg-yellow-300/90 text-white px-2 py-1 rounded-full text-xs font-medium">
